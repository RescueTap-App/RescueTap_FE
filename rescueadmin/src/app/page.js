        ...
        <div className="h-full w-full bg-white text-black px-5">
          <div className="w-full px-24">
            ...
            <div className="text-black"> 
              <Form action="/auth" className="">
              <label className="">Email</label>
                <br />
                <input type="email" placeholder="Enter Text" className="border border-slate-800 rounded px-5 py-1 w-full"/>  
                <br />
                <br />
                <label className="block">Password</label>
                <input type="password"placeholder="Enter Text" className="border border-slate-800 rounded px-5 py-1 w-full"/>
                ...
                <br />
                <br />
                <button className="bg-gray-200 w-full border rounded py-1">Sign in</button>
              </Form>
            </div>
          </div>
        </div>
